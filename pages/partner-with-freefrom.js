...
export default function PartnerWithFreefrom() {
    return (
        <SharedLayout title='Partner with FreeFrom'>
            ...
            <p>
                Is your organization interested in partnering with FreeFrom? Please fill out the following information
                    ...
                    return (
                        <Form className='col-12 col-lg-8 mb-5'>
                            ...
                            <div className='form-group pb-4 mb-3'>
                                ...
                                <Checkbox name='goals' value='policy_innovation_sprint'>
                                    Request a policy innovation sprint
                                </Checkbox>
                                <Checkbox name='goals' value='help_drafting_legislation'>
                                    Help with drafting legislation
                                </Checkbox>
                                <Checkbox name='goals' value='plan_event_or_webinar'>
                                    Plan a policy related event or webinar
                                </Checkbox>
                                <Checkbox name='goals' value='join_survivor_wealth_policy_group'>
                                    Join or learn more about FreeFrom’s Survivor Wealth Policy Group
                                </Checkbox>
                                <Checkbox name='goals' value='pass_survivor_wealth_centered_legislation'>
                                    Pass survivor wealth centered legislation in my state
                                </Checkbox>
                            </div>
                            {props.values.goals &&
