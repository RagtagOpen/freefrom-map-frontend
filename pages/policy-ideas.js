...
export default function PolicyIdeas() {
    return (
        <SharedLayout title='Share Your Policy Ideas'>
            ...
            <p>
                At FreeFrom, we are constantly iterating and brainstorming new ways that we can support survivors
                through policy change at the federal, state, and local levels. We encourage you to share any new policy
                ideas or changes to current policies that would help you, your loved ones, or others in your community
                that have been subjected to violence. Thank you for sharing!
            </p>
                    ...
                    return (
                        <Form className='col-12 col-lg-8 mb-5'>
                            <Input
                                ...
                                label='What policies and issues should FreeFrom prioritize?'
                                name='policies_to_prioritize'
                                required={true}
                            />
                            <Input
                                className='text-uppercase'
