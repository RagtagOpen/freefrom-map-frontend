    ...
    return (
        <SharedLayout>
            ...
            <div className='d-flex flex-row flex-fill'>
                <div className="col-md-3 p-0" style={{ minWidth: '300px' }}>
                    <StatesList states={states} />
                </div>

                <div className="col-md-9 d-none d-md-block">
                    <div aria-hidden='true' className="mb-4 ml-3 d-md-flex flex-row justify-content-start">
                        <div className='d-flex flex-column'>
                            <h4 className="mb-1">Key</h4>
                            <img alt="" className="img-fluid" src="/images/legend.png" style={{maxWidth: '415px'}}/>
                        </div>
                    </div>
                    <UsMap states={states} />
            ...
            <>
                ...
                <div className="d-flex justify-content-center">
                    <img
                        alt="0 states are model states. 2 states are financial security friendly. 11 states are taking steps. 17 steps show some accountability. 21 states show little accountability."
                        className="img-fluid"
                ...
                <div className="d-flex justify-content-lg-around justify-content-center align-items-center flex-column flex-md-row p-2">
                    <div className='d-flex flex-column flex-md-row justify-content-md-between'>
                        <div className='pr-3 mb-3'>
                            ...
                            <img alt="" className="img-fluid mb-3" src="/images/states/maine.png" />
                            <p className="mb-1">
                        ...
                        <div className='pr-3 mb-3'>
                            ...
                            <img alt="" className="img-fluid mb-3" src="/images/states/washington.png" />
                            <p className="mb-1">
                        ...
                        <div className='pr-3'>
                            ...
                            <img alt="" className="img-fluid mb-3" src="/images/states/nevada.png" />
                            <p className="mb-1">
